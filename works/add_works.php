...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          <img src="images/banner.jpg" alt="Works" style="width:100%" style="height: 150px">
          <div class="w3-display-middle w3-large" > <h1 style="color:DodgerBlue;">Add Works Information</h1></div>
      </div>
      <div class="w3-container" style="padding: 50px 200px 20px 200px">
      
      
      <form class="w3-container" action="worksinfo.php" method="post">
          
                 <p><label>Works id</label>
                      <input class="w3-input w3-light-grey w3-animate-input" type="text" name="worksid">
                  </p>
                ...
                <p>
                     <label>Works Type</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="workstype">
                </p>
                <p>
                     <label>Description</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="description">
                </p>
