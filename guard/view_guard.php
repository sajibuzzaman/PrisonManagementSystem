<?php include('guard-up-delete.php')?>
<!DOCTYPE html>
<html lang="en">
...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 style="color:DodgerBlue;" >Guard Information</h1></div>
      </div>
      ...
      <h4>Guard Data</h4>
       ...
       <table>
           ...
           <tr>
			   ...
			   <td><a href="guard-update.php?edit=<?php echo $row['Guard_ID']; ?>" class="w3-button w3-teal" >Edit</a></td>
         <td><a href="guard-up-delete.php?del=<?php echo $row['Guard_ID']; ?>" class="w3-button w3-red">Delete</a></td>
           </tr>
           <?php } ?>
       </table>
      </div>
