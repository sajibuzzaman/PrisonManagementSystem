<?php
include('visitor-up-delete.php');

if(isset($_GET['edit'])){
    $id = $_GET['edit'];
    echo $id;
    $rec = mysqli_query($connection, "SELECT * FROM visitor_info WHERE visitor_id='$id';");
...
<!DOCTYPE html>
<html lang="en">
<title>Visitor Informatiion</title>
...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >Update Visitor Informatiion</h1></div>
      </div>
      <div class="w3-container" style="padding: 50px 200px 20px 200px">
      
      
      <form class="w3-container" action="v-update.php" method="post">
          
                 <p>
                      <input class="w3-input w3-light-grey w3-animate-input" type="hidden" name="visitorid" value="<?php echo $id;?>"></p>
                 <p>
                ...
                <p>
                     <label>Relationship</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="relationship" value="<?php echo $relationship;?>">
                </p>
                <p>
                     <label>Date</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="date" value="<?php echo $date;?>">
                </p>
