...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 style="color:DodgerBlue;">Add Visitor Information</h1></div>
      </div>
      <div class="w3-container" style="padding: 50px 200px 20px 200px">
      
      
      <form class="w3-container" action="visitorinfo.php" method="post">
          
                  <p>
                      <label>Visitor id</label>
                      <input class="w3-input w3-light-grey w3-animate-input" type="text" name="visitorid">
                  </p>
                  <p>
                 ...
                 <p>
                      ...
                      <input class="w3-input w3-light-grey w3-animate-input" type="text" name="relationship">
                 </p>
                 
                 <p>
                        <label>Date</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="date" name="date">
                 </p>
