<?php
include('prisoner-up-delete.php');

if(isset($_GET['edit'])){
    $id = $_GET['edit'];
    echo $id;
    $rec = mysqli_query($connection, "SELECT * FROM prisoner_info WHERE P_ID='$id';");
...
<!DOCTYPE html>
<html lang="en">
<title>Prisoner Informatiion</title>
...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >Update Prisoner Informatiion</h1></div>
      </div>
      ...
      <form class="w3-container" action="p-update.php" method="post">
                 ...
                 <p>
                      <input class="w3-input w3-light-grey w3-animate-input" type="hidden" name="prisonerid" value="<?php echo $id;?>"></p>
                 <p>
                     <label>Name</label>
                ...
                <p>
                     <label>Crime</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="crimetype" value="<?php echo $crimetype;?>">
                </p>
                <p>
                     <label>Crime Location</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="crimelocation" value="<?php echo $crimelocation;?>">
                </p>
                <p>
                     <label>Punishment</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="punishment" value="<?php echo $punishment;?>">
                </p>
                <p>
                     <label>Date</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="pstartdate" value="<?php echo $pstartdate;?>">
                </p>
                <p>
                     <label>Block</label>
