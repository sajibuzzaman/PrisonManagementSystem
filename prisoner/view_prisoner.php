<?php include('prisoner-up-delete.php')?>
<!DOCTYPE html>
<html lang="en">
<title>Prisoner Data</title>
...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 style="color:DodgerBlue;" >Prisoner Information</h1></div>
      </div>
      ...
      <h4>Prisoner Data</h4>
       ...
       <table>
           ...
           <tr>
			   ...
			   <td><a href="prisoner-update.php?edit=<?php echo $row['P_ID']; ?>" class="w3-button w3-teal" >Edit</a></td>
