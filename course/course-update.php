<?php
include('course-up-delete.php');

if(isset($_GET['edit'])){
    $id = $_GET['edit'];
    echo $id;
    $rec = mysqli_query($connection, "SELECT * FROM course WHERE course_ID='$id';");
...
<!DOCTYPE html>
<html lang="en">
<title>Course Informatiion</title>
...
<header role="banner">
  ...
  <!-- Header2 -->
      ...
      <div class="w3-display-container w3-text-blue" style="font-size: 50px">
          ...
          <div class="w3-display-middle w3-large" > <h1 >Update Prisoner Course Informatiion</h1></div>
      </div>
      <div class="w3-container" style="padding: 50px 200px 20px 200px">
      
      
      <form class="w3-container" action="c-update.php" method="post">
          
                 <p>
                      <input class="w3-input w3-light-grey w3-animate-input" type="hidden" name="courseid" value="<?php echo $id;?>"></p>
                 <p>
                ...
                <p>
                     <label>Duration</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="text" name="duration" value="<?php echo $duration;?>">
                </p>
                <p>
                     <label>Start Date</label>
                        <input class="w3-input w3-light-grey w3-animate-input" type="date" name="date" value="<?php echo $date;?>">
                </p>
